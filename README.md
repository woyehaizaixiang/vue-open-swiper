...
[Demo Page](https://woyehaizaixiang.github.io/vue-open-swiper)
...
<script type="text/javascript" src=".../dist/vue-open-swiper.min.js"></script>
```

### Use

``` javascript
Vue.use(window.VueOpenSwiper)
...
### Install vue-open-swiper

``` bash
npm install vue-open-swiper --save
```
...
// import
import Vue from 'vue'
import VueOpenSwiper from 'vue-open-swiper'


// or require
var Vue = require('vue')
var VueOpenSwiper = require('vue-open-swiper')


// mount with global
Vue.use(VueOpenSwiper)


// If used in Nuxt.js/SSR, you should keep it only in browser build environment
if (process.browser) {
  const VueOpenSwiper = require('vue-open-swiper/ssr')
  Vue.use(VueOpenSwiper)
}


// mount with component(can't work in Nuxt.js/SSR)
import { swiper, swiperSlide } from 'vue-open-swiper'
